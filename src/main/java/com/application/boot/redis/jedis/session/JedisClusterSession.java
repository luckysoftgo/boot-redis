package com.application.boot.redis.jedis.session;

import com.application.boot.redis.api.RedisSession;
import com.application.boot.redis.exception.RedisException;
import com.application.boot.redis.utils.JsonUtils;
import com.application.boot.redis.utils.JedisUtil;
...
public class JedisClusterSession implements RedisSession {
    ...
    public <T> T getTypeObject(Class<T> clazz, String key) throws RedisException {
        ...
        try {
            t = JsonUtils.parseJsonToBean(clazz,objStr);
        } catch (Exception e) {
    ...
    public void publish(String chanel, Object msg) {
        ...
        String msgJson =null;
        try {
        	msgJson = JsonUtils.parseBeanToJson(msg);
		}
		catch (Exception e) {
